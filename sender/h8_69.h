...
#define TCNT_WR (*(volatile unsigned short *)0xffff8c)
#define TCSR_WR (*(volatile unsigned short *)0xffff8c)
#define TCNT_RD (*(volatile unsigned char *)0xffff8d)
#define TCSR_RD (*(volatile unsigned char *)0xffff8c)
